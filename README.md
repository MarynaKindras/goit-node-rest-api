# Домашнє завдання. Тема 6. MongoDB и Mongoose
...
Якщо ти все зробив правильно, дані повинні з'явитися у базі в колекції contacts
...
`bash PATCH /api/contacts/:contactId/favorite `
